...
//        Obj Vogais Curtas
                array.add( new TrackModel(R.raw.audio_vc3, "ɪ", false));
                array.add(new TrackModel(R.raw.audio_vc4, "e", false));
                array.add(new TrackModel(R.raw.audio_vc5, "ʊ", false));
                array.add(new TrackModel(R.raw.audio_vc6, "ɒ", false));
                array.add(new TrackModel(R.raw.audio_vc7, "ʌ", false));
                array.add(new TrackModel(R.raw.audio_vc7, "æ", false));
                array.add(new TrackModel(R.raw.audio_vc7, "ə", false));
//                Obj Vogais Longas
                array.add(new TrackModel(R.raw.audio_vc7, "ɑː", false));
